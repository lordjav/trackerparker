...
export class MembershipComponent {
  ...
  addMembershipDialog = inject(MatDialog);
  ...
  constructor(private membershipService: MembershipService) {
    ...
    iconRegistry.addSvgIconLiteral(
      'motorcycle', 
      sanitizer.bypassSecurityTrustHtml(MOTORCYCLE_ICON)
    );
  }
  ...
  addMembership() {
    const dialogRef = this.addMembershipDialog.open(AddMembershipComponent);
  }
}
